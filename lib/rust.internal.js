 ...
 * @param {number | null} [memory_cost]
 * @param {number | null} [time_cost]
 * @param {number | null} [output_len]
 * @param {number | null} [parallelism]
 * @returns {string}
 */
export function hash_password(
  ...
  try {
    ...
    const ret = wasm.hash_password(
      ptr0,
      len0,
      isLikeNone(memory_cost) ? 0x100000001 : memory_cost >>> 0,
      isLikeNone(time_cost) ? 0x100000001 : time_cost >>> 0,
      isLikeNone(output_len) ? 0x100000001 : output_len >>> 0,
      isLikeNone(parallelism) ? 0x100000001 : parallelism >>> 0,
    );
    deferred2_0 = ret[0];
    deferred2_1 = ret[1];
...
export function verify_password(
  ...
  const ret = wasm.verify_password(
    ptr0,
    len0,
    ptr1,
    len1,
